...
def get_raw_dataset(dataset_name, output_path, seed, local_rank):
    if "en_reward_model_dataset" in dataset_name:
        return raw_datasets.EnRewardModelDataset(output_path, seed, local_rank, dataset_name)
    elif "zh_reward_model_dataset" in dataset_name:
        return raw_datasets.ZhRewardModelDataset(output_path, seed, local_rank, dataset_name)
...
def create_prompt_dataset(local_rank,
    ...
    if False and local_rank <= 0 and (reload or buf_create_cache.item() != 0):
        print(data_path)
